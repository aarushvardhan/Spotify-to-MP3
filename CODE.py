...
output_folder = "Downloaded_Songs" #Sample output folder (Rename only for new download otherwise new songs will be downloaded in the same folder as previous.)
